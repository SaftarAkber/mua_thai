            ...
            <div class="space-y-4 xl:space-y-6">
                ...
                <div class="space-y-2">
                    <div class="flex justify-center items-center flex-col space-y-3 text-lg font-medium leading-6">
                        <h3 class="text-[#ECDBBA]">{name}</h3>
                        <p class="text-[#ECDBBA]">{position}</p>
                        <div class="flex justify-center mt-5 space-x-5">
                            <a href="#home" target="_blank" rel="noopener noreferrer" class="inline-block text-gray-400"><span class="sr-only">Twitter</span><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" class="w-6 h-6 text-gray-400 hover:text-gray-100" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            </svg></a><a href="#home" target="_blank" rel="noopener noreferrer"
...
const Roadmap = () => {
    return (
        <div className='grid mx-auto bg-[#161616] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3  gap-16 px-2 sm:px-4 md:px-6 lg:px-8 py-10'>
